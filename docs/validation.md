...
Auto-generated by `backend/scripts/validate.py`. Re-run after any pricing change.
_Generated: 2026-05-16 20:56:02_
...
|----------|------|--------|--------|
| Single BS price + 5 Greeks | `1.016` ms | < 1ms | FAIL |
| 30×30 vol surface (IV invert 900 cells) | `276` ms | < 200ms | soft cap |
| Monte Carlo, 10,000 antithetic paths | `0.7` ms | < 100ms | PASS |
| Binomial CRR, n=500 | `6.8` ms | < 50ms | PASS |
| Binomial CRR, n=1000 | `17.1` ms | n/a | informational |
